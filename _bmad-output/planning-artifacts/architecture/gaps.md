...
| **G1.2** | HMCTS IdP support for OAuth 2.0 client_credentials grant for service principals is assumed. | **No longer Phase 0 blocking** — mock auth provides client_credentials in Phase 0–8. Verification needed before pre-Phase-9 cutover. If unsupported: fallback to mTLS for service-to-service auth (named in Step 4). | Pre-Phase-9 prerequisite — IdP team confirmation |
