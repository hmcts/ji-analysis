...
| Two-UI repo split (both `ram-ui` and `ram-admin-ui` follow the same pattern) | [`../../architecture.md` → Step 4 *Frontend Architecture*](../../architecture.md) — v2.10 |
